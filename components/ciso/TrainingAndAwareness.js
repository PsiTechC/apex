...
//     if (!ciso_email) {
//       alert("No CISO email provided as prop!");
//       e.target.value = "";
//       return;
//     }
...
//       // Collect selected question numbers
//       const selectedQuestions = Array.from(selected).map((i) => i + 1); 
//       // 👆 assuming i+1 is the "question number" you want to store

//       const fd = new FormData();
//       fd.append("email", ciso_email);     // from props
//       fd.append("file", file);            // CSV with emails
//       fd.append("questions", JSON.stringify(selectedQuestions)); // add question numbers
...
//   const onSubmit = () => {
//     const picked = Array.from(selected).map((i) => questions[i]);
//     alert(`Submitted ${picked.length} question(s).`);
//   };
...
//                               {/* Options + correct answer (collapsed by default) */}
//                               {qOpen && (
//                                 <div className="mt-3 ml-7 text-sm text-gray-700">
//                                   <ul className="list-disc pl-5 space-y-1">
//                                     {q.a && <li><strong>A:</strong> {q.a}</li>}
//                                     {q.b && <li><strong>B:</strong> {q.b}</li>}
//                                     {q.c && <li><strong>C:</strong> {q.c}</li>}
//                                     {q.d && <li><strong>D:</strong> {q.d}</li>}
//                                   </ul>
//                                   {q.correct && (
//                                     <p className="mt-2">
